...
public class Q37_RearrangeArray {
    ...
    public static void main(String[] args) {
        ...
        /*
         * ou are given a 0-indexed integer array nums of even length consisting of an
         ...
         */
        Q37_RearrangeArray obj = new Q37_RearrangeArray();
        int[] arr = { 3, 1, -2, -5, 2, -4 };
