...
public class Q12_Merger2DsortedArray {
    public int[][] mergeArrays(int[][] nums1, int[][] nums2) {
        ...
        // we can solve this using two pointer approach it is similar to merging two sorted arrays.
        while(i<m && j<n) {
    ...
    public static void main(String[] args) {
         ...
         */
         ...
         Q12_Merger2DsortedArray obj = new Q12_Merger2DsortedArray();
            int nums1[][] = {{1,2},{2,3},{4,5}};
            int nums2[][] = {{1,4},{3,2},{4,1}};
            int result[][] = obj.mergeArrays(nums1, nums2);
